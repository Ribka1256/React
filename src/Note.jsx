...
function save() {
  ...
  if (editingId !== null) {
    ...
    setNote(note.map((n, i) =>
      i === editingId ? newNote : n
    ));
...
function edit(index){
    ...
    return(
        ...
        <div>
            ...
            <textarea id="text"placeholder="Share your thoughts..." rows="15" cols="50" value={newNote} onChange={handleChange}></textarea>
